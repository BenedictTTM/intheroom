...
export default function Manifesto() {
    return (
        <section className="relative min-h-screen w-full bg-background px-8 py-32 md:px-24">
            <div className="mx-auto max-w-6xl">
                ...
                <div className="mb-24 flex flex-col items-start gap-8 md:flex-row md:items-end md:justify-between">
                    <motion.h2
                        ...
                        className="font-sans text-6xl font-extralight uppercase tracking-tighter text-primary md:text-9xl"
                    >
                ...
                <div className="grid grid-cols-1 gap-16 md:grid-cols-12">
                    ...
                    >
                        <p className="font-sans text-2xl font-light leading-relaxed text-primary md:text-4xl">
                            It's a community of teenagers who have given their lives to be a
                            vessel of the gospel of the Lord Jesus Christ.
                        </p>
                        <p className="mt-12 font-sans text-xl font-light leading-relaxed text-primary/60 md:text-2xl">
