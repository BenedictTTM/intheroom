            ...
            {((editingEvent?.images?.length || 0) > 0 || imagePreviews.length > 0) && (
              <div className="relative group/gallery">
                <button 
                  ...
                  className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 bg-white border border-gray-200 text-gray-600 p-1.5 rounded-full shadow-sm hover:bg-gray-50 transition-all opacity-0 group-hover/gallery:opacity-100"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
                </button>
                ...
                <button 
                  ...
                  className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 bg-white border border-gray-200 text-gray-600 p-1.5 rounded-full shadow-sm hover:bg-gray-50 transition-all opacity-0 group-hover/gallery:opacity-100"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                </button>
              </div>
            ...
            <div key={event.id} className="relative overflow-hidden rounded-sm border border-gray-200 bg-white p-8 transition-all duration-500 hover:shadow-lg flex flex-col justify-between">
              <div>
                <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
                  ...
                  {/* Details */}
                  <div className="flex flex-1 flex-col gap-2 md:pt-2">
